...
module.exports = (() => {
    ...
    return class AutoIdleOnAFK extends Plugin {
        constructor() {
            ...
            this.keyAlwaysOnline = "alwaysOnline"
        ...
        onBlurFunction() {
            ...
            var __alwaysOnline = BdApi.loadData(
                this._config.info.name,
                this.keyAlwaysOnline)
        ...
        onFocusFunction() {
            ...
            this.backFromAFKTimeoutID = setTimeout(() => {
                ...
                var statusIsAFKAndAlwaysOnlineIsTrue = this.currentStatus() === this.settings.afkStatus && this.settings.alwaysOnline === true;
